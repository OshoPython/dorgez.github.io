...
![Figure 3: rain data histogram with the fitted normal distribution PDF function](/assets/img/2024-02-06%20article/observred_data_with_fitter_normal_distribution.png) 
<div style="text-align:center;">
<p style="font-style:italic;">Figure 3: rain data histogram with the fitted normal distribution (PDF) function</p>
</div>

 After compering _figure 2_ to _figure 3_ it was clear that a better fit for the set of AMS is GEV distribution.
...
Where: $F(x_i)$ is the theoretical cumulative distribution function (CDF) $i\text{-th data point}$
 ...
 ![Figure 5: normal distribution CDF with the ECDF of the data for the KS-test result](/assets/img/2024-02-06%20article/Figure_normal_CDF_bigger_same_size_as_.png)
<div style="text-align:center;">
...
[[2]](https://rdcu.be/dyjKW) Volosciuk, C., Maraun, D., Semenov, V. et al. Rising Mediterranean Sea Surface Temperatures Amplify Extreme Summer Precipitation in Central Europe. Sci Rep 6, 32450 (2016). https://doi.org/10.1038/srep32450


![img](/assets/img/2024-02-06%20article/Figure_2_but_smaller.png){:. left}

</p>
<p style="text-align: left"><img src="/assets/img/2024-02-06%20article/Figure_2_but_smaller.png"></p>
