...
same thing did with normal distribution (_figure 4_). after compering _figure 2.1_ to _figure 4_ it was clear that a better fit for the set of AMS is GEV distribution.
...
![Figure 4: rain data histogram with the fitted normal distribution PDF function](/assets/img/2024-02-06%20article/observred_data_with_fitter_normal_distribution.png) 
<div style="text-align:center;">
<p style="font-style:italic;">Figure 4: rain data histogram with the fitted normal distribution (PDF) function</p>
</div>
