...
Where: $F(x_i)$ is the theoretical cumulative distribution function (CDF) $i\text{-th data point}$ for the GEV function (eq 4)
...
**_Table 1:_** Log results from the HEC-SSP analysis
